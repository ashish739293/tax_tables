...
<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-6 mb-5">
            <a href="" class="text-decoration-none">
                <h1 class="mb-4 display-5 font-weight-semi-bold">Tax Tables</h1>
            </a>
            <p>
        ...
        <div class="col-lg-4 col-md-6 mb-5">
            ...
            <div class="d-flex flex-column">
                ...
                <a class="text-dark mb-2" href="/blogs"><i class="fa fa-angle-right mr-2"></i>Blogs</a>
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
        <div class="col-md-6 text-center text-md-left">
            <p class="mb-md-0">
                &copy; <a class="text-dark font-weight-semi-bold" href="/">Tax Tables</a>. All Rights Reserved.
                Designed by <a class="text-dark font-weight-semi-bold" href="">Tax Tables</a>
            </p>
        </div>
