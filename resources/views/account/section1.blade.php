        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="stats">
                    <li>
                        <div class="stat_icon">
                            <img src="{{ asset('uploads/client-icon.png') }}" alt="Clients">
                        </div>
                    ...
                    <li>
                        <div class="stat_icon">
                            <img src="{{ asset('uploads/invoice-icon.png') }}" alt="Invoices">
                        </div>
                    ...
                    <li>
                        <div class="stat_icon">
                            <img src="{{ asset('uploads/projects-icon.png') }}" alt="Projects">
                        </div>
                    ...
                    <li>
                        <div class="stat_icon">
                            <img src="{{ asset('uploads/reconciliation-icon.png') }}" alt="Reconciliation">
                        </div>
                    ...
                    <li>
                        <div class="stat_icon">
                            <img src="{{ asset('uploads/completed-icon.png') }}" alt="Completed Projects">
                        </div>
        ...
        <div class="row align_center">
            <div class="col-lg-6 order_2">
                <div class="text_details">
                    ...
                    <p>
                        Our journey started when an accountant and a marketer joined forces to address 
                        businesses' needs beyond basic number-crunching. We became a team focused on 
                        professionalism, excellence, and delivering results that matter.
                    </p>
                    <div class="cta_link">
